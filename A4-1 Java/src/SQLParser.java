// $ANTLR 3.5.2 SQL.g 2015-04-06 16:15:20
...
public class SQLParser extends Parser {
	...
	@Override public String getGrammarFileName() { return "SQL.g"; }
	  ...
	  private String groupingAtts = null;
		...
		try {
			...
			switch (alt4) {
				case 1 :
					...
					groupingAtts = ((i1!=null?i1.getText():null) + "." + (i2!=null?i2.getText():null));
					...
					while (true) {
						...
						case 1 :
							...
							groupingAtts = ((i3!=null?i3.getText():null) + "." + (i4!=null?i4.getText():null));
							}
							break;
